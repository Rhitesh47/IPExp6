...
import Resume from "../assets/Hitesh Resume.pdf"
    ...
    <section className="bg-gradient-to-l from-black to-slate-800 min-h-screen flex items-center justify-center ">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="inline-box flex justify-center space-x-4">
          <a href={Resume} download="Hitesh Resume">
            <button className="btn-box bg-blue-400 hover:bg-blue-500 text-black font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out">
              Download Resume
            </button>
          </a>
        </div>
